namespace glm
{
	...
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> rotate(mat<4, 4, T, Q> const& m, T angle, vec<3, T, Q> const& v)
	{
		...
		mat<4, 4, T, Q> Result;
//        Result[0] = Rotate[0] * m[0][0] + Rotate[1] * m[0][1] + Rotate[2] * m[0][2];
//        Result[1] = Rotate[0] * m[1][0] + Rotate[1] * m[1][1] + Rotate[2] * m[1][2];
//        Result[2] = Rotate[0] * m[2][0] + Rotate[1] * m[2][1] + Rotate[2] * m[2][2];
//        Result[3] = m[3];
