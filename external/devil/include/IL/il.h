...
#define IL_MDL          0x0431  //!< Half-Life Model TextureType - .mdl extension
#define IL_WAL          0x0432  //!< Quake 2 TextureType - .wal extension
#define IL_LIF          0x0434  //!< Homeworld TextureType - .lif extension
...
#define IL_VTF			0x0444  //!< Valve TextureType Format - .vtf extension
...
#define IL_TPL			0x0448  //!< Gamecube TextureType - .tpl extension
...
#define IL_BLP			0x044C  //!< Blizzard TextureType Format - .blp extension
#define IL_FTX			0x044D  //!< Heavy Metal: FAKK2 TextureType - .ftx extension
#define IL_ROT			0x044E  //!< Homeworld 2 - Relic TextureType - .rot extension
#define IL_TEXTURE		0x044F  //!< Medieval II: Total War TextureType - .texture extension
#define IL_DPX			0x0450  //!< Digital Picture Exchange - .dpx extension
#define IL_UTX			0x0451  //!< Unreal (and Unreal Tournament) TextureType - .utx extension
#define IL_MP3			0x0452  //!< MPEG-1 Audio Layer 3 - .mp3 extension
#define IL_KTX			0x0453  //!< Khronos TextureType - .ktx extension
...
#define IL_DXT1A            0x0711  // Normally the same as IL_DXT1, except for nVidia TextureType Tools.
